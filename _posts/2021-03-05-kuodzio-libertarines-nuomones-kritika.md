...
Apibendrinant: Raimondo suponuojami "tinginiai" ko gero dauguma atvejų nėra tinginiai **laisvu** pasirinkimu, o nedirbantys dėl tam tikrų priežasčių. Todėl jų įvarinimas *Poor by choice* - yra ne kas kita, bet libertatinės ideologijos indokrtinacija ir šių žmonių problemų permetimas tik jiems patiems, ignoruojant mūsų, kaip visiuomenės atsakomybę. Bet aišku, kam rūpi tie "niuansai"?
...
Labai norėčiau palinkėti, kad ateityje profesorius ir [LB valdybos narys, uždirbantis 12 tūkstančių eurų bruto](https://www.lb.lt/lt/informacija-apie-darbo-uzmokesti), būtų labiau empatiškesnis ir tikslesnis dėstydamas savo mintis.
